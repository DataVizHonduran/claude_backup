...
logger = logging.getLogger("fred_client.cache")

_RETRY_STATUS_CODES = frozenset({429, 500, 502, 503, 504})


def build_session(
    cache_name: str = "fred_cache",
    ...
    Args:
        cache_name: SQLite cache file prefix.
        expire_after: Cache TTL in seconds.
        retries: Maximum retry attempts.

    Returns:
        A CachedSession with retry-aware HTTP adapter mounted.
    """
